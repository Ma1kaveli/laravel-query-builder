...
class ApplyNumericLessThanTest extends TestCase
{
    /**
    ...
    public function test_apply_returns_early_if_field_is_not_string()
    {
        ...
        $filter = new ApplyNumericLessThan();
    ...
    {
        $builder = Mockery::mock(EloquentBuilder::class);
        $filter = Mockery::mock(ApplyNumericLessThan::class)->makePartial()->shouldAllowMockingProtectedMethods();
